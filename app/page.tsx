...
export default function Home() {
  const [input, setInput] = useState('3d morphing tubular bubble circular forms of smoke,slinky made of light  and oil, time travel technology, time warp, folding time, shooting lights');
  ...
  const [audioSrc, setAudioSrc] = useState('./neuro1.wav');
      ...
      <div className="mt-auto">
        <div className="flex flex-col items-center justify-center mb-4">
          ...
          <div className="text-center">
            <p className="text-xl mb-2">blackbox hyper-objects 02</p>
            <p className="text-xl mb-2">Play sound and move the mouse to move the object in the right and interact with the generative design and AI model. Concept, generative design, programming, and music by <a href="https://linktr.ee/marlonbarriososolano" target="_blank" rel="noopener noreferrer">Marlon Barrios Solano</a>.</p>
          </div>
        </div>
      </div>
    </main>
